...
/**
  ...
  /**
   * Do the sum of the vector values
   * @contract <sum><vector> ---> <void>
   */
  double sum();

  /**
   * Calculate the average of the vector values
   * @contract <avg><vector> ---> <void>
   */
  double avg();

  /**
   * Return de max value in the vector
   * @contract <max><vector> ---> <void>
   * 
   */
  double max();
